...
@DB(
	...
	,username="root" 
	,password="root" 
	,dbs="db1"            //Enable db service named: db1 (default is disable)
...
public interface DB1 {                                   
	public static DBConfig DB=DBConfig.fromClass(DB1.class);   
	     
	//Code generate(OR  Maven Build / Eclipse Plugin )
	public static class CreateModelClasses{
		public static void main(String[] args)throws Exception{
			//Initialize database 
			String sqlscripts=MelpFile.readToString(DB1.class.getResourceAsStream("/init-db.sql"),"utf-8");
			DB.executeBatch(sqlscripts.split(";")); 
			
			//Generate model classes
			DBModelGenerateMain.generateModelClass(DB1.class,"./target/generated-sources/annotations"); 
		}
	}
}
